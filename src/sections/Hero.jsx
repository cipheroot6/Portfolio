  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-[15%] left-[10%] w-3 h-3 rounded-full bg-purple-400/40 animate-float"
        />
        <div
          className="absolute top-[25%] right-[15%] w-2 h-2 rounded-full bg-cyan-400/50 animate-float-delayed"
        />
        <div
        ...
        />
        <div
          className="absolute top-[80%] left-[40%] w-2 h-2 rounded-full bg-purple-300/30 animate-float-delayed"
        />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] md:w-[350px] md:h-[350px] rounded-full border border-white/[0.04] animate-spin-slow" style={{ animationDirection: 'reverse', animationDuration: '15s' }} />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 w-full max-w-[850px] mx-auto animate-fade-in">
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-[var(--color-text-secondary)] w-full max-w-[600px] mx-auto text-center mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: '0.3s' }}>
          I craft high-performance web applications with clean code, stunning interfaces, and seamless user experiences.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-wrap items-center justify-center gap-4 animate-slide-up mx-auto w-full" style={{ animationDelay: '0.6s' }}>
          <a
            href="#projects"
            data-hover
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-fade-in" style={{ animationDelay: '1.5s' }}>
          <span className="text-xs text-[var(--color-text-muted)] uppercase tracking-[0.2em]">Scroll</span>
